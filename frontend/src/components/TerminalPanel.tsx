...
export function TerminalPanel() {
  ...
  useEffect(() => {
    ...
    const term = new Terminal({
      ...
      letterSpacing: 0.3,
      theme: {
        background: '#0a0e14', foreground: '#e2e8f0', cursor: '#638cff',
        selectionBackground: 'rgba(99,140,255,0.2)',
        black: '#484f58', red: '#f87171', green: '#34d399', yellow: '#fbbf24',
        blue: '#638cff', magenta: '#c084fc', cyan: '#22d3ee', white: '#b1bac4',
        brightBlack: '#6e7681', brightRed: '#fca5a5', brightGreen: '#6ee7b7',
